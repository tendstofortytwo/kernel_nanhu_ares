...
static struct mipi_dsi_phy_ctrl dsi_video_mode_phy_db = {
	...
	{0xbb, 0x02, 0x06, 0x00},
	/* pll control */
#if defined(ILI9486_FWVGA_TWO_LANE)
...
static int __init mipi_video_ili9486_fwvga_pt_init(void)
{
	int ret;

#ifdef CONFIG_FB_MSM_MIPI_PANEL_DETECT
	if (msm_fb_detect_client("mipi_video_ili9486_fwvga"))
		return 0;
#endif
pr_emerg("Flea-mipi_video_ili9486_fwvga_pt_init \n");
	pinfo.xres = 320;
	pinfo.yres = 480;//Flea
...
//------------------------------------no  use --
	...
	pinfo.mipi.mdp_trigger = DSI_CMD_TRIGGER_SW;//Test---DSI_CMD_TRIGGER_NONE;
...
module_init(mipi_video_ili9486_fwvga_pt_init);
